    ...
    <div className="min-h-screen bg-[#0f1419] flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">ENTROPY</h1>
          <p className="text-gray-400">GAMING</p>
        </div>

        <div className="bg-[#1a1f2e] rounded-lg p-8 shadow-xl">
          <h2 className="text-2xl font-bold text-white mb-2">Welcome back</h2>
          <p className="text-gray-400 mb-6">Sign in to Entropy Gaming HQ</p>
